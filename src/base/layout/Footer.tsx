...
export default function Footer() {
  ...
  const navLinks = [
    { href: `/${currentLocale}`, label: isEnglish ? "Home" : "Beranda" },
    {
      ...
      label: isEnglish ? "Featured" : "Fitur",
    },
    {
      href: `/${currentLocale}//#services`,
      label: isEnglish ? "Services" : "Layanan",
    },
    {
      href: `/${currentLocale}/download`,
      label: isEnglish ? "Download" : "Unduh",
    },
  ];
        ...
        <div className="grid gap-10 md:grid-cols-4 text-foreground">
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-sm text-muted-foreground mt-5">
              <Link
                href={
                  "https://wa.me/6285122161588?text=Hallo%20Saya%20Ingin%20Bertanya"
                }
              ...
              <Link
                href={"mailto:rizverse2025@gmail.com"}
                className="flex items-center gap-2"
              >
          ...
          <div>
            <h3 className="mb-4 font-semibold">
              {currentLocale === "en" ? "Social" : "Sosial"}
            </h3>
            <ul className="flex flex-wrap gap-4 text-sm">
              <li>
                <Link
                  ...
                  className="hover:text-foreground/80 flex items-center gap-2"
                >
              ...
              <li>
                <Link
                  href="https://discord.gg/8K8K7PXE"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-foreground/80 flex items-center gap-2"
                >
